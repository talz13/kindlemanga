...
options_bundle_none = dict(bundle_files = 3, dist_dir = './dist/kindlemanga_none')
options_bundle_depends = dict(bundle_files = 2, dist_dir = './dist/kindlemanga_dep')
options_bundle_python = dict(bundle_files = 1, dist_dir = './dist/kindlemanga')
